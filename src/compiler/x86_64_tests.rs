...
fn test_emit_push() {
    assert_eq_hex!(
        compile_to_bytecode("."),
        vec![0x48, 0x8d, 0x64, 0x24, 0xff, 0x41, 0x8a, 0x0, 0x88, 0x4, 0x24,],
    );
    assert_eq_hex!(
        compile_to_bytecode(".."),
        vec![
            0x48, 0x8d, 0x64, 0x24, 0xff, 0x41, 0x8a, 0x0, 0x88, 0x4, 0x24, 0x48, 0x8d, 0x64, 0x24,
            0xff, 0x41, 0x8a, 0x0, 0x88, 0x4, 0x24,
        ],
    );
}
...
fn test_emit_pop() {
    assert_eq_hex!(
        compile_to_bytecode(","),
        vec![0x8a, 0x04, 0x24, 0x41, 0x88, 0x00, 0x48, 0x8d, 0x64, 0x24, 0x1],
    );
    assert_eq_hex!(
        compile_to_bytecode(",,"),
        vec![
            0x8a, 0x04, 0x24, 0x41, 0x88, 0x00, 0x48, 0x8d, 0x64, 0x24, 0x1, 0x8a, 0x04, 0x24,
            0x41, 0x88, 0x00, 0x48, 0x8d, 0x64, 0x24, 0x1,
        ],
    );
}
